...
const previewDemo = [
	{
		img: 'dark',
		title: 'Pan Waśkiewicz (ETNA)',
		routerPath: '/home-dark',
		delayAnimation: '50',
	},
	{
		img: 'light',
		title: 'Pani Waśkiewicz',
		...
		<div>
			<section className='banner text-center'>
				<div className='content'>
					<h1>Pan i Pani Waśkiewicz</h1>
					<h2>Do Twoich usług!</h2>
				</div>
			</section>
			{/* End .banner */}
								...
								<div className='content text-center'>
									<div className='bg_container'>
										<Link to={val.routerPath} target='_blank' rel='noreferrer'>
											<img src={`img/intro/${val.img}.jpg`} alt='demo' className='img-responsive screenshot' />
										</Link>
									</div>
									<h2>{val.title}</h2>
									<div className='anchor'>
										<h6>
											<Link className='btn' to={val.routerPath} target='_blank' rel='noreferrer'>
												cHECK OUT
											</Link>
										</h6>
									</div>
			...
			<footer>
				<div className='go_purchase'>
					...
					<h3 data-aos='fade-up' data-aos-duration='1200' data-aos-delay='100'>
						Purchase Tunis & Build Your Super Fast <span className='theme-color'>React</span> &amp;{' '}
